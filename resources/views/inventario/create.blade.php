...
<div class="custom-card">
    <div class="mb-4 text-center" style="border-bottom: 3px solid #007BFF;">
        <h2 class="fw-bold text-black mb-0">Registro de Inventario Médico</h2>
    </div>
    ...
    <form action="{{ route('inventario.store') }}" method="POST" novalidate>
        ...
        <div class="row mb-3">
            <div class="col-md-3">
                ...
                <input type="text" name="nombre" id="nombre" class="form-control form-control-sm @error('nombre') is-invalid @enderror" maxlength="100" value="{{ old('nombre') }}" required>
            ...
            <div class="col-md-2">
                ...
                <input type="number" name="cantidad" id="cantidad" class="form-control form-control-sm @error('cantidad') is-invalid @enderror" value="{{ old('cantidad') }}" min="0">
            ...
            <div class="col-md-2">
                ...
                <input type="text" name="unidad" id="unidad" class="form-control form-control-sm @error('unidad') is-invalid @enderror" value="{{ old('unidad') }}" maxlength="50" placeholder="cajas, frascos, etc.">
            ...
            <div class="col-md-2">
                ...
                <input type="number" name="precio_unitario" id="precio_unitario" class="form-control form-control-sm @error('precio_unitario') is-invalid @enderror" step="0.01" min="0" value="{{ old('precio_unitario') }}">
        ...
        <div class="row mb-3">
            <div class="col-md-3">
                ...
                <input type="date" name="fecha_ingreso" id="fecha_ingreso" class="form-control form-control-lg" value="{{ old('fecha_ingreso', now()->format('Y-m-d')) }}" required>
            </div>
            <div class="col-md-3">
                <label for="fecha_vencimiento" class="form-label">Fecha vencimiento</label>
                <input type="date" name="fecha_vencimiento" id="fecha_vencimiento" class="form-control form-control-lg @error('fecha_vencimiento') is-invalid @enderror" value="{{ old('fecha_vencimiento') }}">
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <textarea name="descripcion" id="descripcion" class="form-control form-control-lg @error('descripcion') is-invalid @enderror" rows="2" maxlength="200">{{ old('descripcion') }}</textarea>
                @error('descripcion') <div class="invalid-feedback">{{ $message }}</div> @enderror
            </div>
            <div class="col-md-6">
                <label for="observaciones" class="form-label">Observaciones <span class="text-danger">*</span></label>
                <textarea name="observaciones" id="observaciones" class="form-control form-control-lg @error('observaciones') is-invalid @enderror" rows="2" maxlength="200">{{ old('observaciones') }}</textarea>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Botón Limpiar excepto fecha de ingreso

...
<div class="custom-card">
    ...
    <form action="{{ route('inventario.update', $inventario->id) }}" method="POST" novalidate>
        ...
        <div class="row mb-3">
            <div class="col-md-4">
                ...
                <input type="text" name="codigo" id="codigo"
                       ...
                       maxlength="10" value="{{ old('codigo', $inventario->codigo) }}" required>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4">
                ...
                <input type="text" name="unidad" id="unidad"
                       ...
                       value="{{ old('unidad', $inventario->unidad) }}" maxlength="50" placeholder="cajas, frascos, etc.">
        ...
        <div class="d-flex justify-content-center gap-3 mt-4">
            ...
            <button type="button" id="btnRestaurar" class="btn btn-warning">

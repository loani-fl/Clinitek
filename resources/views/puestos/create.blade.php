        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('puestos.store') }}" novalidate>
                ...
                <div class="row g-4 mt-1 px-4">
                    ...
                    <div class="col-md-3">
                        <label for="sueldo" class="form-label fw-semibold text-muted">Sueldo <span class="text-danger">*</span></label>
                ...
                <div class="d-flex justify-content-center mt-4 gap-4 px-4">
                    ...
                    <a href="{{ route('puestos.index') }}" class="btn btn-outline-secondary btn-sm shadow-sm px-4">

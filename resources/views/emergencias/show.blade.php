...
@section('content')
    @php
        ...
        $mostrarFoto = isset($emergencia->foto) && Storage::exists('public/' . $emergencia->foto);
    @endphp
                    ...
                    <div class="{{ $mostrarFoto ? 'col-md-9' : 'col-12' }}">
                        <div class="row gy-2">
                            <div class="col-md-3 info-block">
                                ...
                                <div class="info-value">{{ $emergencia->nombres ?? '—' }}</div>
                            </div>

                            <div class="col-md-3 info-block">
                                <span class="info-label">Apellidos:</span>
                                <div class="info-value">{{ $emergencia->apellidos ?? '—' }}</div>
                            </div>

                            <div class="col-md-3 info-block">
                                <span class="info-label">Identidad:</span>
                                <div class="info-value">{{ $emergencia->identidad ?? '—' }}</div>
                            </div>

                            <div class="col-md-3 info-block">
                                <span class="info-label">Edad:</span>
                                <div class="info-value">{{ $emergencia->edad ?? '—' }}</div>
                            </div>

                            <div class="col-md-3 info-block">
                                <span class="info-label">Sexo:</span>
                                <div class="info-value">
                                    {{ $emergencia->sexo === 'M' ? 'Masculino' : ($emergencia->sexo === 'F' ? 'Femenino' : '—') }}
                                </div>
                            </div>

                            <div class="col-md-3 info-block">
                                <span class="info-label">Teléfono:</span>
                                <div class="info-value">{{ $emergencia->telefono ?? '—' }}</div>
                            </div>

                            <div class="col-md-3 info-block">
                                <span class="info-label">Fecha:</span>
                                <div class="info-value">
                                    {{ !empty($emergencia->fecha) ? \Carbon\Carbon::parse($emergencia->fecha)->format('d/m/Y') : '—' }}
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 info-block">
                                ...
                                <div class="info-value">
                                    {{ !empty($emergencia->hora) ? \Carbon\Carbon::parse($emergencia->hora)->format('h:i A') : '—' }}
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 info-block">
                                ...
                                <div class="info-value" style="white-space: pre-line;">{{ $emergencia->direccion ?: 'Sin dirección registrada.' }}</div>
                            </div>
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    @php
                        $historial = \App\Models\Emergencia::where('identidad', $emergencia->identidad)

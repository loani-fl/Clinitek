...
.custom-card {
    max-width: 1000px;
    background-color: rgba(255, 255, 255, 0.95); /* Fondo blanco semi-transparente para dejar ver la imagen */
    border: 1px solid #91cfff; /* borde azul claro */
...
<div class="custom-card">
  ...
  <div class="col-md-3">
    ...
    <input type="text" name="nombre" id="nombre" maxlength="50" pattern="^[\pL\s]+$" required
  ...
  <div class="col-md-3">
    ...
    <input type="text" name="apellidos" id="apellidos" maxlength="50" pattern="^[\pL\s]+$" required
...
<!-- Fila 3 ahora vacía porque Género está arriba -->
<div class="row mb-3">
    <!-- Puedes quitar esta fila si no tiene contenido -->
</div>

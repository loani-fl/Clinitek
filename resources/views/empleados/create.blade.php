...
<div class="row g-4 mt-3 px-4">
    {{-- Fecha Nacimiento --}}
    <div class="col-md-2">
        @php $anioMax = now()->subYears(18)->format('Y-m-d'); @endphp
        <label for="fecha_nacimiento" class="form-label fw-semibold text-muted">Fecha de Nacimiento <span class="text-danger">*</span></label>
        <input type="date" name="fecha_nacimiento" id="fecha_nacimiento" class="form-control form-control-sm" value="{{ old('fecha_nacimiento') }}" max="{{ $anioMax }}" required>
...
<div class="d-flex justify-content-center mt-5 gap-4 flex-wrap">
    ...
    {{-- Botón Cancelar (Regresar): verde con ícono arrow-left --}}
    <a href="{{ route('empleados.index') }}" class="btn btn-success btn-sm px-4 shadow-sm d-flex align-items-center gap-2">

...
.patient-data-field strong { min-width: 100px; font-weight: normal; color: rgb(3,12,22); font-size: 0.9rem; }
...
.section-title { font-size:1.1rem; margin-bottom:0.7rem; color: rgb(6,11,17); font-weight:700; line-height:1.4rem; }
.examenes-grid { display:flex; flex-direction:column; gap:0.15rem; }
.examenes-grid label { font-size:0.85rem; line-height:1rem; font-weight:normal; color:#0f0f0f; cursor:pointer; display:flex; align-items:center; }
.examenes-grid input[type="checkbox"] { width:auto; height:auto; cursor:pointer; margin-right:0.35rem; vertical-align:middle; }
...
<div class="content-wrapper">
    ...
    <div class="row align-items-center">
        ...
        <div class="col-md-9 text-center" style="transform: translateX(30%);">
            <h4 class="mb-0" style="font-size:1.1rem; font-weight:700; color:#333; line-height:1.3;">CREAR ORDEN DE ULTRASONIDOS</h4>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', function() { 
    ...
    checkboxes.forEach(cb=>{
        cb.addEventListener('change', ()=>{
            if(actualizarTotal() > MAX_EXAMENES) { 

<nav aria-label="Navegación de páginas">
    <ul class="pagination custom-pagination justify-content-center">
        ...
        <li class="page-item {{ $onFirstPage ? 'disabled' : '' }}">
            <a class="page-link btn-paginate" data-page="{{ $currentPage - 1 }}" href="javascript:void(0)">Anterior</a>
        </li>
        ...
        <li class="page-item {{ !$hasMorePages ? 'disabled' : '' }}">
            <a class="page-link btn-paginate" data-page="{{ $currentPage + 1 }}" href="javascript:void(0)">Siguiente</a>
        </li>
    </ul>

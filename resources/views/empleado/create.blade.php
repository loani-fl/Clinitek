...
<div class="content-wrapper">
    <div class="card custom-card shadow-sm">
        <div class="card-header text-center">
           <h5 class="mb-0 text-dark text-center" style="font-size: 2.25rem; font-weight: bold;">Registrar un nuevo empleado</h5>
...
<div class="row mb-3">
 ...
 <div class="row mb-3">
  <div class="col-md-5">
    ...
    <textarea name="direccion" id="direccion" class="form-control" rows="3" required maxlength="250">{{ old('direccion') }}</textarea>
  ...
  <div class="col-md-5">
    ...
    <textarea name="observaciones" id="observaciones" class="form-control" rows="3" required maxlength="350">{{ old('observaciones') }}</textarea>
